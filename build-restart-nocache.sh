...
docker compose -f docker-compose.yml build jerky-tts-bot-battuteapi --no-cache
docker compose -f docker-compose.yml build jerky-tts-bot-api-balancer --no-cache
